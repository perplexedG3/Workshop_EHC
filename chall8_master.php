...
$chall_detail = get_chall_by_id(8);
...
$conn = mysqli_connect('localhost', 'masterr', '', 'ehc-workshop');
mysqli_set_charset($conn, 'UTF8');

$value = isset($_POST['flag']) ? $_POST['flag'] : "";
$result = null;

$flag = false;

if (str_contains($value, "';")) {
    $query = "SELECT Description,hint FROM chall_master WHERE ID_chall='$value'";
            ...
            <div class="flex flex-col items-center py-10 h-[100%]">
                ...
                <div class="md:w-[40%] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
                    <div class="flex flex-col text-white">
                        <span class="text-xl py-5"><?php echo $chall_detail['Chall_name'] ?></span>
                    </div>
                    <form action="" method="POST">
                        <div class="flex flex-row items-center gap-3 pt-5">
                            <label class="relative block w-[100%]">
                                ...
                                <input style="font-family: 'Segoe UI', Arial, sans-serif;" type="text" name="flag" id="flag" placeholder="Search....."
